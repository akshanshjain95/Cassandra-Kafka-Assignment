...
import twitter4j.{HashtagEntity, ResponseList, Status}
...
object ProducerExample extends App {
  ...
  val twitterKafka = new TwitterKafka

  val responseListFuture: Future[List[String]] = twitterKafka.getTweetsOfUser("sajitlko")
  ...
  /**
    ...
    */
  /*responseList.onComplete{
    case Success(value) => println("Successfully completed")
      producer.close()

    case Failure(value) => println("Completed with a Failure")
      producer.close()
  }*/
